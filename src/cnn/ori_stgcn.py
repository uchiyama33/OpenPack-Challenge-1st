...
class OriSTGCN(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.data_bn = nn.GroupNorm(in_channels, in_channels * A.size(1))
        ...
        self.st_gcn_networks = nn.ModuleList(
            (
                ...
                st_gcn(256, out_channels, kernel_size, 1, **kwargs),
            )  # Stride of the temporal convolutionは全て1に
        )
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, dropout=0, residual=True):
        ...
        if not residual:
            ...
            self.residual = nn.Sequential(
                Conv2d(in_channels, out_channels, kernel_size=1, stride=(stride, 1)),
                nn.GroupNorm(8, out_channels),
            )
