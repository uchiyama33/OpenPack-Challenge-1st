...
class SpatialGraphConvLayer(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, Ks: int):
        ...
        super().__init__()
        self.Ks = Ks
        self.conv = nn.Conv2d(in_channels=in_channels, out_channels=out_channels * Ks, kernel_size=1)
...
class TemporalConvLayer(nn.Module):
    def __init__(
        ...
        self.block = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(dropout),
            nn.Conv2d(in_channels, in_channels, (Kt, 1), (stride, 1), ((Kt - 1) // 2, 0)),
            nn.BatchNorm2d(in_channels),
            nn.ReLU(),
        )
...
class STGCN4Seg(nn.Module):
    ...
    def __init__(
        ...
        inplane2 = inplanes[1]
        inplane3 = inplanes[2]
        self.stgc1 = STConvBlock(in_channels, inplane1, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        self.stgc2 = STConvBlock(inplane1, inplane1, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        self.stgc3 = STConvBlock(inplane1, inplane1, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        self.stgc4 = STConvBlock(inplane1, inplane1, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        # self.stgc1 = STConvBlock(in_channels, inplane1, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        # self.stgc2 = STConvBlock(inplane1, inplane2, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        # self.stgc3 = STConvBlock(inplane2, inplane3, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        # self.stgc4 = STConvBlock(inplane3, inplane3, Ks=Ks, Kt=Kt, num_vertex=num_vertex)

        self.stgc5 = STConvBlock(inplane1, inplane2, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        self.stgc6 = STConvBlock(inplane2, inplane2, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        self.stgc7 = STConvBlock(inplane2, inplane3, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        self.stgc8 = STConvBlock(inplane3, inplane3, Ks=Ks, Kt=Kt, num_vertex=num_vertex)

        # self.stgc9 = STConvBlock(inplane2, inplane3, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        # self.stgc10 = STConvBlock(inplane3, inplane3, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        # self.stgc11 = STConvBlock(inplane3, inplane3, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
        # self.stgc12 = STConvBlock(inplane3, inplane3, Ks=Ks, Kt=Kt, num_vertex=num_vertex)
