...
issue_list = [
    "conv_transformer_avec_plusLSTM-seed65-d6-h20-np50-peFalse-timestep1000-bs32-lr0.0001-labelsm0-mixup0.8_0-shuffle0.2_0-w_kappa_loss0-imu300_keypoint300-ht30_printer30",
    "conv_transformer_avec_plusLSTM-seed66-d6-h20-np50-peFalse-timestep1000-bs32-lr0.0001-labelsm0-mixup0.8_0-shuffle0.2_0-w_kappa_loss1-imu300_keypoint300-ht30_printer30",
    "conv_transformer_avec_plusLSTM-seed67-d6-h20-np50-peFalse-timestep1000-bs32-lr0.0001-labelsm0-mixup0.8_0.5-shuffle0.2_0.8-w_kappa_loss0-imu300_keypoint300-ht30_printer30",
    "conv_transformer_avec_plusLSTM-seed68-d6-h20-np50-peFalse-timestep1000-bs32-lr0.0001-labelsm0-mixup0.8_0.5-shuffle0.2_0.8-w_kappa_loss1-imu300_keypoint300-ht30_printer30",
    "conv_transformer_avec_plusLSTM-seed69-d6-h20-np50-peFalse-timestep1000-bs32-lr0.0001-labelsm0-mixup0.8_0.5-shuffle0.2_0-w_kappa_loss0-imu300_keypoint300-ht30_printer30",
]
config_dir_list = [
    "/workspace/logs/all/conv_transformer_avec_plusLSTM/",
    "/workspace/logs/all/conv_transformer_avec_plusLSTM/",
    "/workspace/logs/all/conv_transformer_avec_plusLSTM/",
    "/workspace/logs/all/conv_transformer_avec_plusLSTM/",
    "/workspace/logs/all/conv_transformer_avec_plusLSTM/",
...
output_dir = f"/workspace/logs/avec/conv_onlyLSTM_all_avec_mean_stacking{len(issue_list)}_0116_average_slide{average_slide}_del10col"
