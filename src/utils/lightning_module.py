...
from utils.model import (
    ...
    myConvTransformer,
    myConvTransformerAVEC,
    myConvTransformerAVECplusLSTM,
    mySimpleTransformer,
    myTransformer,
    myTransformerAVEC,
...
class TransformerPL(optorch.lightning.BaseLightningModule):
    def init_model(self, cfg: DictConfig) -> torch.nn.Module:
        ...
        if cfg.model.name == "simple_transformer":
            model = mySimpleTransformer(
        ...
        elif cfg.model.name == "transformer_plusLSTM":
            model = myTransformerPlusLSTM(
                num_classes=len(OPENPACK_OPERATIONS),
                cfg=cfg,
            )
        ...
        elif cfg.model.name == "conformer_avec":
            model = myConformerAVEC(
                num_classes=len(OPENPACK_OPERATIONS),
                cfg=cfg,
            )
        elif cfg.model.name == "transformer_avec":
            model = myTransformerAVEC(
                num_classes=len(OPENPACK_OPERATIONS),
                cfg=cfg,
            )
        elif cfg.model.name == "conformer_avec_plusLSTM":
            model = myConformerAVECplusLSTM(
                num_classes=len(OPENPACK_OPERATIONS),
                cfg=cfg,
            )
        ...
        elif cfg.model.name == "conv_transformer_avec":
            model = myConvTransformerAVEC(
                num_classes=len(OPENPACK_OPERATIONS),
                cfg=cfg,
            )
        elif cfg.model.name == "conv_transformer_avec_plusLSTM":
